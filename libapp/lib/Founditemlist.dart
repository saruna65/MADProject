...
class FoundItemList extends StatefulWidget {
  ...
  @override
  _FoundItemListState createState() => _FoundItemListState();
}

class _FoundItemListState extends State<FoundItemList> {
  late Stream<QuerySnapshot> _foundItemsStream; // Stream for lost items
  ...
  List<DocumentSnapshot> _filterLostItems(List<DocumentSnapshot> documents) {
    if (_searchQuery.isEmpty) {
      ...
      return documents.where((document) {
        ...
        final lostItem = data['Found Item'] ?? '';
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final foundLocation = data?['Found Location'] ?? '';
                    final foundItem = data?['Found Item'] ?? '';
