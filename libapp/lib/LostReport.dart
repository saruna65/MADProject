...
class LostReport extends StatefulWidget {
  const LostReport({Key? key}) : super(key: key);

  @override
  _LostReportState createState() => _LostReportState();
}
...
class _LostReportState extends State<LostReport> {

  final TextEditingController personNameController = TextEditingController();
  final TextEditingController facultyController = TextEditingController();
  final TextEditingController batchController = TextEditingController();
  final TextEditingController contactNoController = TextEditingController();
  final TextEditingController lostItemController = TextEditingController();
  ...
  void sendDataToFirebase() {
    ...
    String lostLocation = lostLocationController.text;
    String lostItem = lostItemController.text;
